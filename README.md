...
The VST3 plugin is at `build/macos/Enaga/EnagaPlugin_artefacts/Debug/VST3/Enaga.vst3`.
...
`build/linux/Enaga/EnagaPlugin_artefacts/Debug/VST3/Enaga.vst3/`.
...
The VST3 plugin is at
`build\windows\Enaga\EnagaPlugin_artefacts\Debug\VST3\Enaga.vst3\`.
...
The AUv3 extension is generated by the Xcode build under
`build/ios/Enaga/EnagaPlugin_artefacts/Debug/AUv3/`.

Open the generated Xcode project to build and deploy from Xcode:
